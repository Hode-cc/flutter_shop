...
class HomeMoreList extends StatefulWidget {
  ...
  HomeMoreList({Key? key, required this.recommendList}) : super(key: key);

  @override
  HomeMoreListState createState() => HomeMoreListState();
}

class HomeMoreListState extends State<HomeMoreList> {
